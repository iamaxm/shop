...
$order_sql = "SELECT * FROM orders WHERE status = 'ได้รับสินค้าแล้ว' ORDER BY orderUpdate_status_date ASC;";
    ...
    <table class="table">
      <thead>
        <tr class="text-nowrap">
          ...
          <th style="font-size: 16px; text-align: center;">วันที่ลูกค้ากดยืนยันสินค้า </th>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="modalCenterTitle<?php echo $order_row['order_id']; ?>" style="margin-right: 30px;font-size:30px">รายการสินค้าที่ลูกค้าได้รับแล้ว</h5>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <?php endwhile; ?>
                        <tr>
                          <td><span class="badge rounded-pill bg-label-success" style="font-size: 20px;">ราคารวมทั้งหมด <?php echo $order_row['total_amount']; ?> ฿</span></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
