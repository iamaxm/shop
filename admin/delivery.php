...
$order_sql = "SELECT * FROM orders WHERE status = 'กำลังจัดส่งสินค้า'  ORDER BY orderUpdate_status_date ASC";
      ...
      <table class="table">
        <thead>
          <tr class="text-nowrap">
            ...
            <th style="font-size: 16px;">รายการสินค้าทั้งหมด</th>
            <th style="font-size: 16px;">อัปเดตสถานะ</th>
          </tr>
        </thead>
        <tbody>
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="modalCenterTitle<?php echo $order_row['order_id']; ?>" style="margin-right: 30px;font-size:30px">รายการที่ต้องจัดส่ง</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>

                      <table class="table">

                        <u align="left" style="margin-left: 2rem;"><br>ที่อยู่ที่ต้องจัดส่ง</u>
                        <p align="left" style="margin-left: 2rem; font-size:16px;"><?php echo $order_row['address']; ?> ตำบล <?php echo $order_row['sub_district']; ?> อำเภอ <?php echo $order_row['district']; ?> <br> จังหวัด <?php echo $order_row['province']; ?> รหัสไปรษณีย์ <?php echo $order_row['zipcode']; ?></small></p>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><span class="badge rounded-pill bg-label-warning">สถานะปัจจุบัน : <?php echo $order_row['status']; ?></span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                          </tr>
              ...
              <form action="backNe/BN_status_success.php" method="post">
                <td>
                  ...
                  <div style="display: inline-block;">
                    ...
                    <button type="submit" class="btn btn-outline-success">จัดส่งสินค้า</button>
                  </div>
                </td>
              </form>
            </tr>
