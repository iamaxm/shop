...
$sql = "INSERT INTO `log`(`date`, `log`) VALUES ('$date','1');;";
...
?>
    ...
    <title>Vegetable and fruit</title>
   ...
   <?php
    ...
    switch ($favcolor) {
      ...
      case "product_received":
        // include("navbar.php");
        include("product_received.php");
        break;
      case "howto_payment":
        include("navbar.php");
        include("howto_payment.php");
        break;
      case "reset_password":
        // include("navbar.php");
        include("forgot_password/reset_password.php");
        break;
